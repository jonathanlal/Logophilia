...
public class UploadFileCover extends HttpServlet {
	private static final long serialVersionUID = 1L;
	  private static final int BUFFER_SIZE = 2 * 1024 * 1024;


	public UploadFileCover() {
		super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String username;
	    	...
	    	String bucketName = "logophilia/userfiles/"+username+"/images/covers";
		...
		try {
            ...
            while (iterator.hasNext()) {
                ...
                if (item.isFormField()) {
                	...
                	if(fieldname.equals("imgURL")){
                        ...
                        UserBean ub = new UserBean();
				  		...
				  		if(imgURL.contains(".")){
				  			...
				  			ub.setCoverImage(username, imgURL);
				  			session.setAttribute("coverImg", imgURL);
				  				}
                   ...
                   imgUpload = "https://storage.googleapis.com/logophilia/userfiles/"+username+"/images/covers/"+sname;
                   ...
                   ub.setCoverImage(username, imgUpload);
                   
     				session.setAttribute("coverImg", imgUpload);
