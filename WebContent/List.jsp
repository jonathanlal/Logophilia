...
<div class="container"  style="display: block;">
 ...
 <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
  ...
  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="padding-top: 4px;">
   ...
   <input name="edit" type="button" class="btn btn-default" value="Add Words" role="button" data-toggle="modal" data-target="#Addwordslist">
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
	 ...
	 <div class="jumbotron" style="width: auto;" >
	                    ...
	                    <h2 class="text-center"> ${listname}  <img class="listslist" src="img/lists.png"> </h2>	
	                    <ul class="list-group">
	                    
  <li class="list-group-item" style="height: 50px;width: 345px;"> <p>Words:<span class="text-success"> ${listsize}</span></p>									</li>
...
<c:forEach items="${wordsfromDB}" var="wordvary" varStatus="count">
	...
	<a data-toggle="collapse" href="#collapse${count.index}" ><b>${wordvary}</b></a><a><span class="pull-right"><c:out value="${count.count}"></c:out>
					</span></a> 
					</h4>
					</div>
					...
					<ul class="list-group">
					<c:forEach items="${definitionsfromDB[count.index]}" var="def" varStatus="count3">
...
<c:if test="${fn:contains(SavedWordsListCheck[count.index], 'no')}">
				...
				<input type="hidden" name="word" value="${wordvary}">
				 ...
				 <button class="btn btn-default btn-sm pull-right" value="" name="" data-toggle="modal" data-target="#removeWord${count.index}">Remove Word</button>
