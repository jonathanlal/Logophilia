 ...
 <div class="panel with-nav-tabs panel-default" style="width: 100 px;">
                <div class="panel-heading">
                        <ul class="nav nav-tabs">
                            <li class="active"><a href="#tab1default" data-toggle="tab">House Lists</a></li>
                            <li><a href="#tab2default" data-toggle="tab">Recently added Words</a></li>
							<li><a href="#tab2default" data-toggle="tab">Most Liked Words</a></li>
...
<!--             <div class="row"> -->
<!--               <div class="col-md-12"> -->
<!--                 <h1 style="text-align: center;">Word Lists</h1> -->
<!--                 <p>All available lists from server and users</p> -->
<!--               </div> -->
<!--             </div> -->
                ...
                <div class="col-sm-6"> 
                    ...
                    <div class="brdr bgc-fff pad-10 box-shad btm-mrg-20 property-listing">
                        <div class="media">
                            ...
                            <img alt="image" class="img-responsive" src="http://curemyphobia.co.uk/wp-content/uploads/2016/04/Phobia-1-1.jpg"></a>
                            ...
                            <div class="media-body fnt-smaller">
                                ...
                                <br/>
                                  <a href="#" target="_parent">List of phobias <small class="pull-right">Tyler</small></a></h4>


                                <ul class="list-inline mrg-0 btm-mrg-10 clr-535353">
                                    <li>cost 10 points</li>

                                    <li style="list-style: none">|</li>

                                    <li>MIN RANK: Neophyle</li>
                                ...
                                <p class="hidden-xs">Here is a huge phobias</p><span class="fnt-smaller fnt-lighter fnt-arial">Courtesy of HS Fox  Roach-Chestnut Hill
                                Evergreen</span>
                            </div>
                            <div class="pull-right"><a><br/>	<span class="glyphicon glyphicon-thumbs-up"></span><button type="button" class="btn btn-link">Like</button>
				<span class="glyphicon glyphicon-comment"></span><button type="button" class="btn btn-link">Comment</button>
				<span class="glyphicon glyphicon-share-alt"></span><button type="button" class="btn btn-link">Add to your Lists</button></a></div>
                        </div>
                    </div><!-- End Listing-->
                    ...
                    <div class="brdr bgc-fff pad-10 box-shad btm-mrg-20 property-listing">
                        <div class="media">
                            ...
                            <div class="media-body fnt-smaller">
                                ...
                                historical s...</p><span class="fnt-smaller fnt-lighter fnt-arial">Courtesy of HS Fox  Bell</span>
                            </div>
                        </div>
                    </div><!-- End Listing-->
                    ...
                    <div class="brdr bgc-fff pad-10 box-shad btm-mrg-20 property-listing">
                        <div class="media">
                            ...
                            <div class="media-body fnt-smaller">
                                ...
                                stree...</p><span class="fnt-smaller fnt-lighter fnt-arial">Courtesy of HS hestnut Hill
                                Evergreen</span>
                            </div>
                        </div>
                    </div><!-- End Listing-->
                    ...
                    <div class="brdr bgc-fff pad-10 box-shad btm-mrg-20 property-listing">
                        <div class="media">
                            ...
                            <div class="media-body fnt-smaller">
                                ...
                                firepla...</p><span class="fnt-smaller fnt-lighter fnt-arial">Courtesy of HS Ft Hill
                                Evergreen</span>
                            </div>
                        </div>
                    </div><!-- End Listing-->
