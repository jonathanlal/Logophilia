									...
									<div class="form-group">
										<div class="row">
											<div class="col-sm-6 col-sm-offset-3">
												<input type="submit" name="register-submit" id="register-submit" tabindex="4" class="form-control btn btn-register" value="Send new password">
											</div>
										</div>
									</div>
								</form>
...
<h5>Sometimes we forget our password. But that's okay. You can just reset it. </h5>
<h6><b></b></h6>
</div>
